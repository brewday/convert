...
import io.brewday.convert.xmladapters.BooleanStringAdapter;
...
public class RecipeList {
    ...
    private List<BeerSmithRecipe> data = new ArrayList<>();
    ...
    public List<BeerSmithRecipe> getData() {
        return data;
    }

    public void setData(List<BeerSmithRecipe> data) {
        this.data = data;
    }
    //</editor-fold>
}
